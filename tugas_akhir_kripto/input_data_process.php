...
function superEncrypt($text, $caesarShift, $desKey) {
    $caesarEncrypted = caesarEncrypt($text, $caesarShift); // First apply Caesar Cipher
    return desEncrypt($caesarEncrypted, $desKey); // Then apply DES Encryption
}
