                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active" style="margin-left:80px;">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-5">
                                ...
                                <input required type="text" class="form-control" name="key_for_text1" id="key_for_text1"
                    ...
                    <div class="carousel-item" style="margin-left:180px; margin-top:30px;">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-5" style="width:620px;">
                                <label for="key_for_picture" class="form-label">Key (LSB)</label>
                                <input required type="text" class="form-control" name="key_for_picture" id="key_for_picture"
                                    placeholder="Masukkan key">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item" style="margin-left:180px; margin-top:30px;">
                        ...
                        <div class="row mb-3" style="width:620px;">
                            <div class="col-md-5">
                                <label for="key_for_file" class="form-label">Key (AES-256)</label>
